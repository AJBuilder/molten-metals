...
public class MoltenSteelFluid extends MoltenMetalFluid {

    public MoltenSteelFluid(Properties properties, Supplier<? extends LiquidBlock> block) {
    ...
    public ModFluidRenderProperties createRenderProperties() {
        return new MoltenMetalRenderer(
                MoltenMetals.res("block/molten_steel"),
                MoltenMetals.res("block/molten_steel_flowing"),
                -1,
                MoltenMetals.res("block/molten_steel_flowing"),
                MoltenMetals.res("block/molten_steel_flowing"),
                new Vec3(133, 0, 0));
    ...
    public Fluid getFlowing() {
        return ModFluids.FLOWING_MOLTEN_STEEL.get();
    }

    @NotNull
    public Fluid getSource() {
        return ModFluids.MOLTEN_STEEL.get();
    }
