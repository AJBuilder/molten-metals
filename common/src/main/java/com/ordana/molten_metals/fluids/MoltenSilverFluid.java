...
public class MoltenSilverFluid extends MoltenMetalFluid {

    public MoltenSilverFluid(Properties properties, Supplier<? extends LiquidBlock> block) {
    ...
    public Fluid getFlowing() {
        return ModFluids.FLOWING_MOLTEN_SILVER.get();
    }

    @NotNull
    public Fluid getSource() {
        return ModFluids.MOLTEN_SILVER.get();
    }

    @NotNull
    public Item getBucket() {
        return ModItems.MOLTEN_SILVER_BUCKET.get();
    }
