...
public class ModCreativeTabs {
    ...
    public static final CreativeModeTab MOD_TAB = !CommonConfigs.CREATIVE_TAB.get() ? null :
            PlatformHelper.createModTab(MoltenMetals.res("molten_metals"),
                                        () -> ModItems.MOLTEN_IRON_BUCKET.get().getDefaultInstance(),
                                        false);
    ...
    public static boolean ETCETERA_TAB_EXISTS = PlatformHelper.isModLoaded("etcetera");
    public static boolean OREGANIZED_TAB_EXISTS = PlatformHelper.isModLoaded("oreganized");
    public static boolean GALOSPHERE_TAB_EXISTS = PlatformHelper.isModLoaded("galosphere");
    public static boolean CAVERNS_AND_CHASMS_TAB_EXISTS = PlatformHelper.isModLoaded("caverns_and_chasms");
    public static boolean CREATE_DD_TAB_EXISTS = PlatformHelper.isModLoaded("create_dd");
    public static boolean SPELUNKERY_TAB_EXISTS = PlatformHelper.isModLoaded("spelunkery");
/*
    ...
    private static void afterML(RegHelper.ItemToTabEvent event, Item target,
                                ...
                                Supplier<?>... items) {
        if (PlatformHelper.isModLoaded(modLoaded)) {
